...
namespace pwiz.ProteowizardWrapper.Common.SystemUtil
{
    // Ignore Spelling: im
    ...
    public class Immutable
    {
        ...
        {
            // If not already read-only, make read-only, and if not already an array
        ...
        /// <param name="set">The delegate used to set the property (usually a lambda expression)</param>
